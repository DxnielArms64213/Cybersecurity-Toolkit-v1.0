...
* Provides a password strength score and classification
...
Allows users to generate cryptographic hashes from input data.
...
The project was tested using a range of valid, invalid, and boundary inputs across all major features.
...
* Port scanning timeouts and errors
* File hashing
* Invalid file paths
* Text encoding and decoding
* Valid and invalid subnet input
* Empty log files
* Failed login detection
* Suspicious PowerShell detection
* Administrator account detection
* Failed login alert thresholds
* Multiple security events within the same log

Detailed test results are documented in [`Testing.md`](Testing.md).

Screenshots demonstrating the functionality of the toolkit are available in the [`Screenshots`](Screenshots) directory.

Test data used during development and testing is available in the [`Test-Data`](Test-Data) directory.
